...
#data = pd.read_csv('C:/Users/eng-a/Documents/UAI/MLOps/SE03/CC_Fraude/data/creditcard.csv')
...
# %%
#Gráfico para ver como se distribuye la variable Objetivo
...
# %%
#Seleccionar las variables numérciasnuméricas del data frame
num_vars = [
    'age',
    'ejection_fraction',
    'serum_creatinine',
...
# %%
#Desplegar gráficos con la distribución de las variables numéricas
for var in num_vars:
    plt.figure(figsize=(4,3))
...
# %%
#Comparación del riesgo relativo de las variables que son binarias
...
# %% [markdown]
# El modelo presenta un buen desempeño en la identificación de pacientes sin evento (sobrevivientes, DEATH_EVENT = 0), clasificando correctamente 37 de 41 casos. En contraste, la sensibilidad para detectar pacientes con evento de muerte (DEATH_EVENT = 1) es moderada, identificando correctamente 11 de 19 casos.
